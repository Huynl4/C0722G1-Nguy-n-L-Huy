...
<head>
    ...
    <link rel="stylesheet" href="style_furama.css">
...
<div class=" container-fluid vh-100" style="width: 100%">
    ...
    height: 600px;">
            ...
            <div class="sidebar">
                <a href="#About" style="text-decoration: none">Loại Phòng</a>
            </div>
            <div class="sidebar">
                <a href="#About" style="text-decoration: none">Ẩm thực</a>
            </div>
            <div class="sidebar">
                <a href="#About" style="text-decoration: none">Hội nghị và sự kiện</a>
            </div>
            <div class="sidebar">
                <a href="#About" style="text-decoration: none">Spa</a>
            </div>
            <div class="sidebar">
                <a href="#About" style="text-decoration: none">Giải trí</a>
            </div>
            <div class="sidebar">
                <a href="#About" style="text-decoration: none">Điểm đến</a>
            </div>
        </div>
        <div style="height: 100%" class="col-md-10 col-lg-10">
            <nav class="navbar navbar-expand-lg bg-light" ; style="background-color: #0dcaf0">
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <img src="https://pix10.agoda.net/hotelImages/10953/-1/877b0347b8ca19a7047a3ccd7600f89d.jpg?ca=9&ce=1&s=1024x768"
                                 class="d-block w-100">
                        </div>
                        <div class="carousel-item active">
                            <img src="https://admin.begodi.vn/web/image/47922"
                                 class="d-block w-100">
                        </div>
                    </div>
