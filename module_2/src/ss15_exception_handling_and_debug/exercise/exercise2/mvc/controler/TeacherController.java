...
import ss15_exception_handling_and_debug.exercise.exercise2.mvc.service.impl_teacher.ITeacherService;
import ss15_exception_handling_and_debug.exercise.exercise2.mvc.service.impl_teacher.TeacherService;
...
public class TeacherController {
    ...
    public static void menuTeacher() throws CodeException {
        while (true) {
            System.out.println("---------------------------------------------------");
